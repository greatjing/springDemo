...
<div class="body_wrap">
    <div class="container">
        <div class="alert alert-success text-center" role="alert">jsp 练习
            <table class="table table-striped table-bordered">
                ...
                <tr>
                    <c:forEach var="jspexercise" items="${jspexercises}">
                        <tr class="text-info">
                            <td th:text="${jspexercise.name}">a</td>
                            <td th:text="${jspexercise.title}">标题</td>
                            <td><a href="#" th:href="${jspexercise.url}" class="btn btn-search btn-green" target="_blank"> <span>click</span> </a></td>
                        </tr>
                    </c:forEach>
                </tr>
            </table>
